...
class RoleuserController extends Controller
{
    ...
    {
        Gate::authorize('can-access', ['roleuser', 'view']);
    ...
    {
        Gate::authorize('can-access', ['roleuser', 'insert']);
    ...
    {
        Gate::authorize('can-access', ['roleuser', 'edit']);
    ...
    {
        Gate::authorize('can-access', ['roleuser', 'delete']);
