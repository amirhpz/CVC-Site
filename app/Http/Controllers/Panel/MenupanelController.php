...
class MenupanelController extends Controller
{
    ...
    {
        Gate::authorize('can-access', ['menupanel', 'view']);
    ...
    {
        Gate::authorize('can-access', ['menupanel', 'insert']);
    ...
    {
        Gate::authorize('can-access', ['menupanel', 'edit']);
...
//        $menu->priority         = $request->input('priority');
    ...
    {
        Gate::authorize('can-access', ['menupanel', 'delete']);
