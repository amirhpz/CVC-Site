    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                @if(Gate::allows('can-access', ['employee', 'insert']))
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content text-center">
                    ...
                    <div class="modal-body">
                        آیا از حذف این عضو تیم مطمئن هستید؟
                    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addform" data-type="create" method="POST" class="row g-4 mb-4" action="{{ route('employee.store') }}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-floating form-floating-outline">
                                ...
                                <label for="instagram">ایمیل / لینک اجتماعی</label>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="team-upload-box">
                                <label for="image_file" class="form-label">تصویر عضو تیم</label>
                                <input type="file" class="form-control" id="image_file" name="image_file" accept="image/*">
                                <small class="text-muted d-block mt-2">برای کارت تیم و صفحه پروفایل استفاده می‌شود. حداکثر ۵ مگابایت.</small>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="form-floating form-floating-outline">
