    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                @if(Gate::allows('can-access', ['emploee', 'insert']))
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addform" data-type="create" method="POST" class="row g-4 mb-4" action="{{ route('emploee.store') }}">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-floating form-floating-outline">
                                <input type="text" class="form-control" id="image" name="image" placeholder="storage/team/member.jpg">
                                <label for="image">مسیر تصویر عضو</label>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="form-floating form-floating-outline">
